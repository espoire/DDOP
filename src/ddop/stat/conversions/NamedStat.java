...
public class NamedStat {
    ...
    static {
        ...
        new NamedStat("sheltering")         .addBonus(new Stat("prr", null, 0))
                                            .addBonus(new Stat("mrr", null, 0));
        new NamedStat("physical sheltering").addBonus(new Stat("prr", null, 0));
        new NamedStat("magical sheltering") .addBonus(new Stat("mrr", null, 0));
		...
		new NamedStat("stormreaver's thunderclap:").addBonus(new Stat("stormreaver's thunderclap", "default", 1));
